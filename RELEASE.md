...
- Authentication uses a dedicated GitHub App (`NC_SDK_RELEASE_CLIENT_ID`,
  `NC_SDK_RELEASE_PRIVATE_KEY`), **not** the default `GITHUB_TOKEN`: events
...
|---|---|---|---|
| `NC_SDK_RELEASE_CLIENT_ID` | variable | `versioning.yml` | GitHub App client ID for release-please |
| `NC_SDK_RELEASE_PRIVATE_KEY` | secret | `versioning.yml` | GitHub App private key |
