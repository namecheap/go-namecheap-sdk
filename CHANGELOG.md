...
Entries after 2.7.0 are generated by
[release-please](https://github.com/googleapis/release-please) from
Conventional Commit history (see [RELEASE.md](RELEASE.md)); earlier entries
follow [Keep a Changelog](https://keepachangelog.com/en/1.1.0/).

## [2.10.4](https://github.com/namecheap/go-namecheap-sdk/compare/v2.10.3...v2.10.4) (2026-09-14)


### Bug Fixes

* **deps:** bump golang.org/x/time from 0.15.0 to 0.16.0 ([#187](https://github.com/namecheap/go-namecheap-sdk/issues/187)) ([f690b13](https://github.com/namecheap/go-namecheap-sdk/commit/f690b13e47775bb71af38175b3a69c494350f74c))

## [2.10.3](https://github.com/namecheap/go-namecheap-sdk/compare/v2.10.2...v2.10.3) (2026-08-31)


### Bug Fixes

* **deps:** bump github.com/stretchr/testify from 1.12.0 to 1.12.1 ([#178](https://github.com/namecheap/go-namecheap-sdk/issues/178)) ([269bc28](https://github.com/namecheap/go-namecheap-sdk/commit/269bc28271600fe5d8799b703e33b8a4f11a6aba))

## [2.10.2](https://github.com/namecheap/go-namecheap-sdk/compare/v2.10.1...v2.10.2) (2026-08-25)


### Bug Fixes

* **deps:** bump github.com/stretchr/testify from 1.11.1 to 1.12.0 ([#175](https://github.com/namecheap/go-namecheap-sdk/issues/175)) ([8b43586](https://github.com/namecheap/go-namecheap-sdk/commit/8b4358688d3606a0075f23912cc4eed92e2a4efa))
* expose DomainDetails on the domains.renew result and accept non-padded API dates ([#177](https://github.com/namecheap/go-namecheap-sdk/issues/177)) ([f3e73b8](https://github.com/namecheap/go-namecheap-sdk/commit/f3e73b8d0b17aa255a9efa543c1bb3b8d48a4b28))

## [2.10.1](https://github.com/namecheap/go-namecheap-sdk/compare/v2.10.0...v2.10.1) (2026-08-14)


### Bug Fixes

* expose the full domains.getInfo response including Whois privacy ([#168](https://github.com/namecheap/go-namecheap-sdk/issues/168)) ([fce8e5b](https://github.com/namecheap/go-namecheap-sdk/commit/fce8e5b168e26d56d37604261b2fdb6dc6aef5c9))

## [2.10.0](https://github.com/namecheap/go-namecheap-sdk/compare/v2.9.0...v2.10.0) (2026-08-01)


### Features

* **dns:** record-level operations accept an explicit EmailType ([#163](https://github.com/namecheap/go-namecheap-sdk/issues/163)) ([44339a9](https://github.com/namecheap/go-namecheap-sdk/commit/44339a9809faffa5ce4e9f658772289225776fe2))

## [2.9.0](https://github.com/namecheap/go-namecheap-sdk/compare/v2.8.0...v2.9.0) (2026-08-01)


### Features

* **amount:** export Amount.IsPositive and document the 0.0 promotion sentinel ([#159](https://github.com/namecheap/go-namecheap-sdk/issues/159)) ([b63e775](https://github.com/namecheap/go-namecheap-sdk/commit/b63e775cc9d95edd6e20ec546ccd7de8e8d1dd16))

## [2.8.0](https://github.com/namecheap/go-namecheap-sdk/compare/v2.7.2...v2.8.0) (2026-08-01)


### Features

* **users:** parse Currency and PromotionPrice on getPricing Price tiers ([#155](https://github.com/namecheap/go-namecheap-sdk/issues/155)) ([90e7d7e](https://github.com/namecheap/go-namecheap-sdk/commit/90e7d7e5d600480705056fff20eb5701e63cd9d9))


### Bug Fixes

* **deps:** bump golang.org/x/text from 0.38.0 to 0.39.0 ([#156](https://github.com/namecheap/go-namecheap-sdk/issues/156)) ([f4723d1](https://github.com/namecheap/go-namecheap-sdk/commit/f4723d14609c3b8766a1c838e68ae96d2b855e0f))

## [2.7.2](https://github.com/namecheap/go-namecheap-sdk/compare/v2.7.1...v2.7.2) (2026-07-28)


### Bug Fixes

* **observability:** don't source log/stats command from secret-bearing request map ([#153](https://github.com/namecheap/go-namecheap-sdk/issues/153)) ([cecc510](https://github.com/namecheap/go-namecheap-sdk/commit/cecc5109b5620fc4655b52f0a3f204d36108272e))

## [2.7.1](https://github.com/namecheap/go-namecheap-sdk/compare/v2.7.0...v2.7.1) (2026-07-27)


### Bug Fixes

* **otelnamecheap:** correct the submodule module path (drop erroneous /v2) ([ee013ab](https://github.com/namecheap/go-namecheap-sdk/commit/ee013abb1d9f09d8f834dd72163080b0087a5dbe))
